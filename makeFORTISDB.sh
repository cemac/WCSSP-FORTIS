...
create table files(id INTEGER PRIMARY KEY AUTOINCREMENT, filename TEXT, title TEXT, description TEXT, workshop TEXT, type TEXT, who TEXT, author TEXT);
create table timetables(id INTEGER PRIMARY KEY AUTOINCREMENT, filename TEXT, workshop TEXT, author TEXT);
EOF
